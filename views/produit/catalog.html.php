        ...
        <table class="table table-striped w-75 mx-auto">
            ...
            ?>
                ...
                <tr>
                    ...
                    ?></td>
                    <td>
                        <a href="/produit-crud/router.php/details-produit?id=<?php echo $element->id ?>" class="btn btn-primary w-100">Détails</a> 
                        <a href="/produit-crud/router.php/supprimer-produit?id=<?php echo $element->id ?>" class="btn btn-danger w-100">Supprimer</a>
                        <a href="/produit-crud/router.php/modifier-produit?id=<?php echo $element->id ?>" class="btn btn-warning w-100 ">Modifier</a>
                    </td>
                </tr>
